    ...
    def generate(self):
        ...
        sector_summary = (
            ...
            .agg(
                ...
                avg_op_margin=("operating_profit_margin_pct", "mean"),
                ...
                avg_quality=("quality_rank", "mean"),
            )
            .reset_index()
        )
        sector_summary = sector_summary.sort_values(by="avg_quality", ascending=False)
        ...
        sector_summary.to_csv(OUTPUT / "sector_summary.csv", index=False)
        ...
        print("Sector summary saved to " "output/sector_summary.csv")
