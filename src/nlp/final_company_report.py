...
narratives = pd.read_csv("output/company_narratives.csv")
...
final_df = (
    pros_cons.merge(cashflow, on="company_id", how="inner")
    .merge(allocation, on="company_id", how="inner")
    .merge(narratives, on="company_id", how="inner")
)
...
final_df.to_csv("output/final_company_report.csv", index=False)
...
print("Output saved: output/final_company_report.csv")
